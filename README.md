...
## Duplicates removal: 
I started by inspecting my data by checking duplicated data. This was done by converting the data range into a table format using Ctrl + T or click the home tab>styles menu>click on format as tables.
